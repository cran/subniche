#' @import ade4
#' @title The Within Outlying Mean Index analysis
...
#' @description  The analysis allows to divide the reference niche, estimated from the \link[ade4]{niche} function in the \link{ade4} package into subniches defined by a factor, which creates the
#' subscales. See details for more information.
#' @usage subniche(nic, factor)
#' @param nic an object of class \code{niche}.
#' @param factor a factor which will defined the subscales within which the subniches will be calculated (the same length of the number of sites)
...
#' @return \code{factor} the factor use to divide the environmental and species matrix into subscale.
#' @return \code{mav} a dataframe with the subscale origins, \emph{G'}.
#' @return \code{mus} a dataframe with the subscale species niche coordinates
#' @keywords subniche
